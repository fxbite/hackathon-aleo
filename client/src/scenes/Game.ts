...
export default class Game extends Phaser.Scene {
  ...
  create(data: { network: Network }) {
    ...
    const tilekey = this.map.addTilesetImage('tileset', 'tiles_wall');
    ...
    this.myPlayer = this.add.myPlayer(545, 495, 'male', this.network.mySessionId)
    ...
    this.addGroupFromTiled('Wall', 'tiles_wall', 'tileset', true);
    this.addGroupFromTiled('Objects', 'tiles_wall', 'tileset', false);
    this.addGroupFromTiled('ObjectsOnCollide', 'tiles_wall', 'tileset', true);
    this.addGroupFromTiled('GenericObjects', 'tiles_wall', 'tileset', false);
  ...
  update(t: number, dt: number) {
    if (this.myPlayer && this.network) {
      ...
      this.myPlayer.update(this.playerSelector, this.cursors, this.keyE, this.keyF, this.network)
    }
  }
}
